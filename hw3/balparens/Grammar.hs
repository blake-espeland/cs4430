...
happyExpList = Happy_Data_Array.listArray (0,18) ([320,0,640,40960,1280,32832,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_balparens","Q","S","P","'{'","'}'","'('","')'","%eof"]
...
happyReduction_3 (HappyAbsSyn6  happy_var_2)
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (Node "X" [happy_var_1, happy_var_2]
	)
...
balparens tks = happyRunIdentity happySomeParser where
