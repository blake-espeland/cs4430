...
happyExpList = Happy_Data_Array.listArray (0,35) ([26624,26624,256,1536,0,0,26624,0,0,0,4096,24576,24576,26624,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_inequality","L","PA","T","PL","A","'<'","'+'","'*'","'('","')'","'x'","'y'","%eof"]
...
happyReduction_1 (HappyAbsSyn5  happy_var_3)
	...
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn4
		 (Node "L" [happy_var_1, leaf "<", happy_var_3]
	)
...
happyReduction_4 (HappyAbsSyn8  happy_var_3)
	...
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn6
		 (Node "E" [happy_var_1, leaf "*", happy_var_3]
	)
...
happyError' :: () => ([(Char)], [Prelude.String]) -> HappyIdentity a
happyError' = HappyIdentity Prelude.. (\(tokens, _) -> parseError tokens)
inequality tks = happyRunIdentity happySomeParser where
